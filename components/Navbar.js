...
export default function Navbar() {
  ...
  return (
    <nav className="bg-green-600 text-white p-4 flex justify-between items-center">
      <Link href="/"><a className="flex items-center"><img src="/logo.png" alt="Izba Przyjęć" className="h-8 mr-2"/><span className="font-bold text-lg">Izba Przyjęć</span></a></Link>
